...
#define UART_RX1_BUFFER_SIZE 8 /**< Size of the circular receive buffer, must be power of 2 */
#define UART_RX2_BUFFER_SIZE 8 /**< Size of the circular receive buffer, must be power of 2 */
#define UART_RX3_BUFFER_SIZE 8 /**< Size of the circular receive buffer, must be power of 2 */

#define UART_TX0_BUFFER_SIZE 8 /**< Size of the circular transmit buffer, must be power of 2 */
#define UART_TX1_BUFFER_SIZE 8 /**< Size of the circular transmit buffer, must be power of 2 */
#define UART_TX2_BUFFER_SIZE 8 /**< Size of the circular transmit buffer, must be power of 2 */
#define UART_TX3_BUFFER_SIZE 8 /**< Size of the circular transmit buffer, must be power of 2 */
